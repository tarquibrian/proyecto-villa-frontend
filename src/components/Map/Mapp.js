...
class Mapp extends Component {
  constructor(props) {
    ...
    this.geoPositionClick = this.geoPositionClick.bind(this);
  }
  ...
  geoPositionClick() {
    window.navigator.geolocation.getCurrentPosition((pos) => {
      this.getOrigin = pos.coords;
      document.getElementById("ORIGIN").value = pos.coords.coords;
      ...
      <div className="map">
        <div className="map-settings">
          ...
          <button
            ...
            type="button"
            onClick={this.geoPositionClick}
          >
            Agregar mi ubicacion
          </button>
          <button
            className="btn btn-primary"
            type="button"
